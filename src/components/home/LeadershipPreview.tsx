...
export default function LeadershipPreview() {
  ...
  const Badge = ({ 
    ...
    return (
      <span className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-bold uppercase tracking-wider ${variants[variant]}`}>
        {children}
      </span>
    );
  };

  // Inline Card Component with Advanced Features
  const LeaderCard = ({ 
    leader,
    index
  }: { 
    ...
    <section className="relative bg-gradient-to-b from-slate-50 via-white to-slate-50 py-24 overflow-hidden">
      ...
      <div className="container relative mx-auto max-w-7xl px-6">
        ...
        <div className="mb-16">
          <div className="flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
            ...
            <div className="max-w-2xl">
              ...
              <h2 className="text-5xl font-bold text-gray-900 mt-4 mb-4">
                Leadership Team
              </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <p className="text-xl text-gray-600 leading-relaxed mb-4">
                    Meet the visionary leaders guiding HOVULF's mission and driving daily implementation with passion and expertise.
                  </p>
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-3">
          {leadershipBySlug.slice(0, 3).map((leader, index) => (
